    ...
    <div className="bg-gray-800 p-4 rounded-lg h-full flex flex-col text-white">
      ...
      <div className="flex-grow overflow-y-auto pr-2 pb-8 custom-scrollbar">
        ...
        <div className="space-y-3">
          ...
          />
          <ToolButton 
              onClick={() => setActivePanel('PETIT_LYRICS_IMPORTER')}
              disabled={!song}
              variant="primary"
              label={t('petitLyrics.title')}
              icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>}
          />
          <ToolButton 
