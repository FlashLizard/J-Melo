...
export type PanelType = 'AI_TUTOR' | 'SENTENCE_EDITOR' | 'AI_CORRECTOR' | 'TOOL_PANEL' | 'FULL_LYRICS_EDITOR' | 'SONG_INFO_EDITOR' | 'LYRIC_TRANSLATION_PANEL' | 'TIMELESS_LYRICS_IMPORTER';
